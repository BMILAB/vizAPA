...
## ----celltype_order, message=FALSE, warning=FALSE-----------------------------
...
## ----vizStats_dot_PAs, fig.show="hold", message=FALSE, warning=FALSE----------
...
## ----vizStats_violin_allPAs, fig.show="hold", message=FALSE, warning=FALSE----
vizStats(scPACds, group='celltype', figType="violin")

## ----vizStats_statTheme, fig.show="hold", message=FALSE, warning=FALSE--------
...
## ----vizStats_selGroups, fig.show="hold", message=FALSE, warning=FALSE--------
...
## ----vizUMAP1, message=FALSE, warning=FALSE-----------------------------------
...
## ----bar_markerNum, warning=FALSE, message=FALSE------------------------------
countAPAmarkers(m)
...
## ----vizAPAMarkers_umap, message=FALSE, warning=FALSE-------------------------
# Plot the UMAP plot
vizAPAMarkers(iPACds, group='celltype', markers=m$rowid[1:6], 
...
## ----vizAPAMarkers_sRUD, message=FALSE, warning=FALSE-------------------------
...
## ----vizAPAMarkers_cnt, message=FALSE, warning=FALSE--------------------------
...
## ----vizAPAmarkers3, warning=FALSE, message=FALSE-----------------------------
vizAPAMarkers(scPACds, group='celltype', 
              markers=m$rowid[1:5], 
              figType = 'violin')
...
## ----vizAPAmarkers4, warning=FALSE, message=FALSE-----------------------------
vizAPAMarkers(scPACds, group='celltype', 
              markers=m$rowid[1:5], 
              figType = 'violin')
